...
export default function MainContent() {
  return (
    <main className="flex-1 overflow-y-auto bg-white p-8 h-[calc(100vh-53px)]">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center py-12">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="w-16 h-12 bg-[#06b6d4] rounded-sm relative">
                ...
                <div className="absolute top-2 left-3 w-2 h-2 bg-white"></div>
                <div className="absolute top-2 right-3 w-2 h-2 bg-white"></div>
                <div className="absolute bottom-2 left-2 w-2 h-2 bg-white"></div>
                <div className="absolute bottom-2 right-2 w-2 h-2 bg-white"></div>
                <div className="absolute bottom-0 left-4 w-8 h-2 bg-white"></div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              { name: 'BrainGrid', type: 'Planning', desc: 'Plan. Build. Verify. Repeat.', icon: 'bg-green-500' },
               ...
               <div key={integration.name} className="border border-gray-200 rounded-xl p-4 flex gap-4 hover:border-cyan-300 transition-colors cursor-pointer shadow-sm">
                 ...
                 <div>
                    <div className="flex items-center gap-2">
                       ...
                       <span className="text-[10px] bg-gray-100 text-gray-500 px-1.5 py-0.5 rounded border border-gray-200">{integration.type}</span>
                    </div>
        ...
        <div className="flex flex-wrap items-center gap-3 mb-8">
           <div className="relative flex-1 min-w-[200px] max-w-sm">
              ...
              <input 
                ...
                className="w-full pl-9 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/20"
              />
           </div>
           <button className="flex items-center justify-between gap-2 px-3 py-2 bg-gray-50 border border-gray-200 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100 min-w-[140px]">
              All categories
              <ChevronDown className="w-4 h-4 text-gray-400" />
           </button>
           <button className="flex items-center gap-2 px-3 py-2 bg-gray-50 border border-gray-200 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100">
              <SlidersHorizontal className="w-4 h-4" />
              Filters
           </button>
           <div className="flex bg-gray-50 border border-gray-200 rounded-md p-0.5">
              <button className="p-1.5 bg-white shadow-sm rounded-sm text-gray-800">
        ...
        <div className="flex items-center justify-between mb-6">
           <div className="flex items-center gap-3">
             <span className="text-sm font-semibold text-gray-700">865 components</span>
             <button className="text-xs font-medium bg-gray-100 hover:bg-gray-200 text-gray-700 px-3 py-1.5 rounded-full transition-colors">
               + Add Page to Stack
             </button>
           </div>
           <div className="flex items-center gap-2 text-xs text-gray-400">
             <kbd className="px-1.5 py-0.5 bg-gray-50 border border-gray-200 rounded text-gray-500 font-sans">⌘K</kbd> to search
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
           {componentsList.map((comp, i) => (
             <div key={i} className="border border-gray-200 rounded-xl p-5 hover:border-gray-300 hover:shadow-md transition-all cursor-pointer flex flex-col bg-white">
                <div className="flex items-start gap-4 mb-3">
                   ...
                   <div className="flex-1">
                      <h3 className="font-semibold text-gray-900 leading-tight">{comp.title}</h3>
                   </div>
                </div>
                <p className="text-sm text-gray-500 mb-4 line-clamp-3 flex-1">{comp.desc}</p>

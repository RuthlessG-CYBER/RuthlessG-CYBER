...
export default function SidebarLeft() {
  return (
    <aside className="w-64 border-r border-white/10 bg-[#0f0f11] flex flex-col h-[calc(100vh-53px)] overflow-y-auto">
      <div className="p-4 flex-1">
        
        <div className="mb-6">
          <h3 className="text-xs font-semibold text-gray-400 mb-2 px-2 uppercase tracking-wider">Workplace</h3>
          <nav className="space-y-0.5">
            <a href="#" className="flex items-center gap-3 px-2 py-1.5 text-sm text-gray-400 hover:bg-white/5 hover:text-white rounded-md">
        ...
        <div className="mb-6">
          ...
          <nav className="space-y-0.5">
            {[
              ...
              <a key={item.label} href="#" className="flex items-center justify-between px-2 py-1.5 text-sm text-gray-400 hover:bg-white/5 hover:text-white rounded-md">
                <div className="flex items-center gap-3">
                  <item.icon className="w-4 h-4" />
                  {item.label}
                </div>
                <span className="text-xs bg-white/10 text-gray-400 px-1.5 py-0.5 rounded">{item.count}</span>
              </a>
            ))}
          </nav>
        </div>
        ...
        <div className="mb-6">
          ...
          <nav className="space-y-0.5">
            ...
            <a href="#" className="flex items-center justify-between px-2 py-1.5 text-sm text-gray-400 hover:bg-white/5 hover:text-white rounded-md">
              <div className="flex items-center gap-3">
